...
T26|x|Autocomplete word replace: on Tab accept, delete current word prefix before inserting suggestion. Reuse `current_word_prefix()` length. Add `delete_backwards(n)` to `EditorBuffer`|T19,V7
