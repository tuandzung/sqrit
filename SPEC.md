...
T7|.|connection picker screen: list saved connections, filter by name, select to connect|T6,T3
T8|.|3-pane layout: Explorer sidebar (left), Query (top-right), Results (bottom-right). Status bar bottom.|T1
